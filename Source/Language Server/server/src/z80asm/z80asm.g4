...
directive_assign: (DEFC symbol EQUALS expression) {this.z88dk}? | (symbol EQU expression) {this.zmac}?;
...
NUMBERdec: DIGIT10+ 'd'?;
NUMBERhex: (DIGIT16+ H) | (DOLLAR DIGIT16+) | ('0x' DIGIT16+);
